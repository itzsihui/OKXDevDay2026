/** Fashion-focused buyer copy — discovery ranks via GET /api/search. */

export const FASHION_HEADLINE = "Fashion buyer agent";

export const FASHION_SUBCOPY =
  "Chat with your personal salesperson to clarify what you want. When ready, the agent ranks apparel via GET /api/search over the live market (same endpoint external agents use). You choose Visa or USDT0 and authorize before anything pays. Catalog text cannot change payee, amount, or skip authorize.";
