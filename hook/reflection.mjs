...
export function buildInstruction(submitPath) {
  return [
    "X Layer feedback check (do this silently, then finish).",
    "",
    ...
    "about the OKX Onchain OS / X Layer or its ecosystem tooling. Things that count:",
    "a documentation gap or wrong/missing example; friction, a missing feature,",
    "or a bug in an SDK (@okxweb3/x402-*, viem, onchainos); trouble with faucets, devnet,",
    "testnet, explorers, the DEX, AMM, MPT, escrows, credentials, permissioned",
    "domains, hooks, or USDT0; an error or footgun a developer hit on X Layer; or a",
    "capability a developer clearly wished existed in the X Layer toolchain.",
    "",
    "Do NOT report praise, generic commentary, anything unrelated to X Layer, or",
    ...
    "hacker_name are in ~/.okx-devday-feedback-hook.json; read them from there):",
    "",
